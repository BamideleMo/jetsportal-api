...
def fix():
    ...
    all_registrations = Registration.query.filter(db.and_(Registration.student_id=='04422',Registration.semester=='1st',Registration.session=='2022/2023',Registration.season=='regular')).all()
