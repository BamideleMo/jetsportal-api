...
class Student(db.Model):
    ...
    def generate_matric_number(self):
        ...
        if self.programme_category == 'Diploma Programme' or self.programme_category == 'Bachelor of Arts Programme':
            level = "UG"
        if self.programme_category == 'PGDT Programme' or self.programme_category == 'Masters Programme' or self.programme_category == 'Master of Divinity Programme':
            level = "PG"
...
class Registration(db.Model):
    ...
    dean_print_add_drop=db.Column(db.Text)
    bursar_print_add_drop=db.Column(db.Text)
    registrar_print_add_drop=db.Column(db.Text)
